...
////// Emissive:
                ...
                float3 emissive = ((_Color.rgb*pow(1.0-max(0,dot(normalDirection, viewDirection)),_FresnelPower)*_FresnelPower)+(node_9620*_SpecularColor.rgb));
